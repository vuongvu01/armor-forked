...
import { Button, Dialog, DialogTitle, DialogContent, DialogActions } from '../../../src/components/';
                 ...
                 <>
                     ...
                     >
                         <DialogTitle>
                             ...
                             <Button onClick={() => setMaxWidth('xs')} disabled={maxWidth === 'xs'} marginRight={2}>XS</Button>
                              <Button onClick={() => setMaxWidth('sm')} disabled={maxWidth === 'sm'} marginRight={2}>SM</Button>
                              <Button onClick={() => setMaxWidth('md')} disabled={maxWidth === 'md'} marginRight={2}>MD</Button>
                              <Button onClick={() => setMaxWidth('lg')} disabled={maxWidth === 'lg'} marginRight={2}>LG</Button>
                              <Button onClick={() => setMaxWidth('xl')} disabled={maxWidth === 'xl'}>XL</Button>
                         </DialogTitle>
                         <DialogContent>
