...
export class Application {
    ...
    private async processCLI() {
        ...
        program
            ...
            .description('Armor`s component property parser')
            .on('--help', () => {
                // eslint-disable-next-line no-console
                console.log(`
✉️  Contact author: https://www.linkedin.com/in//
🐛 Submit issue or request feature: https://github.com/deliveryhero/props-parser/issues
`);
            });
