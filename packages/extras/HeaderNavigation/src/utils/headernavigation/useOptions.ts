...
import { OptionFormatType, OptionType } from '@deliveryhero/armor';
import { DropdownInternalOptionType } from '../../components/HeaderNavigation/HeaderNavigationSelector/type';
