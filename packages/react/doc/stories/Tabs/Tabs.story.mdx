...
import {Badge, Box, Tab, Tabs, TabView} from 'src/components';
...
<Preview>
    <Story name="WithCounterBadge" height="240px">
        {() => {
...
return (
    <>
        <Tabs onSwitch={handleChange}>
            ...
            <Tab disabled>
                Alcoholic beverages<Badge marginLeft={badgeLeftMargin}>11</Badge>
            </Tab>
        </Tabs>
        <TabView value={0} selectedValue={selectedTabIndex}>
            <p>Pizza</p>
