...
describe('<LoginPage />', () => {
    ...
    it('should contain correct CSS classes and attributes', () => {
        ...
        // @ts-ignore
        expect(result.container).toHaveBEMStructure('LoginPage', {
            Root: [],
        });
    });
    ...
    it('should support forwardRef', () => {
        ...
        render(<LoginPage ref={result.current} />);
    ...
    it('should support margin attributes', async () => {
        // @ts-ignore
        expect(LoginPage).toSupportMarginAttributes();
    });

    it('should forward correct attributes', async () => {
        // @ts-ignore
        expect(LoginPage).toSupportAttributeForwarding();
    });
});
