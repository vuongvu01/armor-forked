...
export const EllipsisVerticalIcon: FunctionComponent<SVGIconPropsType> = props => {
    ...
    return <SVGIcon {...restProps} className={`EllipsisVerticalIcon ${className || ''}`}>{EllipsisVerticalIconShape}</SVGIcon>;
};
