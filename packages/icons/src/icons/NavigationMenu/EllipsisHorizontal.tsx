...
export const EllipsisHorizontalIcon: FunctionComponent<SVGIconPropsType> = props => {
    ...
    return <SVGIcon {...restProps} className={`EllipsisHorizontalIcon ${className || ''}`}>{EllipsisHorizontalIconShape}</SVGIcon>;
};
