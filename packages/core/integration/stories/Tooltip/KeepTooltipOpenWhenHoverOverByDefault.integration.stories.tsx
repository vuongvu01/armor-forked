...
export const KeepTooltipOpenWhenHoverOverByDefault = () => {
    return (
...
KeepTooltipOpenWhenHoverOverByDefault.play = async ({ canvasElement }) => {
...
export default {
    title: 'Integration/Tooltip/KeepTooltipOpenWhenHoverOverByDefault',
    component: KeepTooltipOpenWhenHoverOverByDefault,
};
