...
export type DatePickerActionBarPropsType =
    DatePickerActionBarEffectivePropsType &
        Partial<{
...
export type DatePickerActionBarRootPropsType =
    DatePickerActionBarEffectivePropsType & ComponentElementStylePropsType;
